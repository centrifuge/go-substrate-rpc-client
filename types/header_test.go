...
func TestHeader_EncodedLength(t *testing.T) {
	assertEncodedLength(t, []encodedLengthAssert{{exampleHeader, 276}})
}

func TestHeader_Encode(t *testing.T) {
	assertEncode(t, []encodingAssert{
		{exampleHeader, mustDecodeHexString("")}, //nolint:lll
	})
}

func TestHeader_Hash(t *testing.T) {
	assertHash(t, []hashAssert{
		{exampleHeader, mustDecodeHexString("0xd592a63761257b0d523e3362721b230ac0ee7c7ac7a1ef7ca5e2180bdcda7f01")},
	})
}

func TestHeader_Hex(t *testing.T) {
	assertEncodeToHex(t, []encodeToHexAssert{
		{exampleHeader, ""}, //nolint:lll
	})
}
