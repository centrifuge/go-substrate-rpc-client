...
func (i IBC) QueryDenomTrace(denom string) (transfertypes.QueryDenomTraceResponse, error) {
...
func (i IBC) QueryDenomTraces(offset, limit uint64, height uint32) (*transfertypes.QueryDenomTracesResponse, error) {
